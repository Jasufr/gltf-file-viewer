...
const Menu = (props) => {
  ...
  const { handleOnChange, handleOnSelect, modelInputValue, modelSelectValue, selectedFile, setSelectedFile, setEnvironment } = props;
      ...
      >
        <div className="flex-1 flex items-start mt-20 flex-col gap-6 p-8">
          <div className="w-full h-full">
            ...
            <div className="text-slate-50 py-1 text-lg font-semibold mt-4 mb-2">Preloaded Models</div>
            ...
            <div className="text-slate-50 py-1 text-lg font-semibold mt-8 mb-2">Environments</div>
